...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogin,
    ...
    this.tvSignUpRedirect = tvSignUpRedirect;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvSignUpRedirect;
      TextView tvSignUpRedirect = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, cardViewForm, etEmail,
          etPassword, tvForgotPassword, tvSignUpRedirect, tvTitle);
    }
